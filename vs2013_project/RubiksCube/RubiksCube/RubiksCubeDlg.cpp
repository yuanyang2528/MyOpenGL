...
CRubiksCubeDlg::CRubiksCubeDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CRubiksCubeDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CRubiksCubeDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDOK, &CRubiksCubeDlg::OnBnClickedOk)
	ON_BN_CLICKED(IDCANCEL, &CRubiksCubeDlg::OnBnClickedCancel)
END_MESSAGE_MAP()
...
void CRubiksCubeDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CRubiksCubeDlg::OnBnClickedOk()
{
...
void CRubiksCubeDlg::OnBnClickedCancel()
{
	close_flag = false;
	CDialogEx::OnCancel();
}
